...
<title>butterflies</title>
  <link rel="stylesheet" href="${ctx }/css/butterflies/css/reset.css">

    <link rel="stylesheet" href="${ctx }/css/butterflies/css/style.css" media="screen" type="text/css" />
</head>
<body>
...
<section class="scene3d">
  ...
  <div class="butterfly_container scale_third" 
	...
	<a href="${ctx}/book_page.html" style="position: absolute;bottom: 0;">book_page</a>
	<input type="button" value="book_page" style="opacity:0.2;" onclick="${ctx}/book_page.html">
</body>
</html>